    ...
    <style>
        ...
        * {
        ...
        .RatingPage {
            ...
            z-index: 9999; /* Assure que la boîte modale est au-dessus de tout le reste */
        }
        .ContenuRatings {
            background-color: #fff; /* Fond blanc */
            width: 50%; /* Largeur de la boîte modale */
        ...
        .business-type-circle {
            ...
            background-color: #007bff; /* Sets background color of the circle */
            display: flex;
            justify-content: center;
            align-items: center;
        ...
        .rating {
            display: flex; /* Displays stars in a row */
            align-items: center;
        }

        /* Styles for filled star */
        .fas.fa-star {
            color: #FFC700; /* Sets color of filled star to gold */
        }
...
.star-selected {
    color: #FFE070; /* Couleur des étoiles sélectionnées */
        ...
        .buttonRatings{
            ...
            background-color: #007bff; /* Sets background color of buttons */
...
<nav>
    ...
    <div id="RatingPage" class="RatingPage">
        <div class="ContenuRatings">
             <!-- Business Header Section -->
            <div class="business-header">
                <div class="business-image">
                <img alt="Business Image" src="{{ asset('storage/' . $bonPlan->img) }}"> <!-- Image representing the business -->
                </div>
                <div class="business--info">
                    ...
                    <div class="business-name-type">
                        ...
                        <div class="star-rating">
                            <input type="hidden"  value="{{ $bonPlan->rate_moy }}">
                                @for ($i = 1; $i <= 5; $i++)
                                    <span class="star-icon {{ $i <= $bonPlan->rate_moy ? 'star-selected' : '' }}">&#9733;</span>
                                @endfor
                        </div>
                    </div>
            ...
            <div class="AddRating">
                ...
                <form id="addRatingForm" method="POST" action="{{ route('ratings.store', ['bon_plan_id' => $bonPlan->id, 'user_id' => $user->id]) }}" enctype="multipart/form-data">
                    ...
                    <div class="PartieCommentaire">
                        <div class="PartieCommentaire1">
                            <p class="TitrePutYourRating">Description</p>
            ...
            <div class="ContenuRating">
                ...
                <div class="ExempleFeedback1">
                    @php
                        $userRating = \App\Models\User::find($rating->user_id);
                    @endphp
                    <img class="ImageUserRatings" src="{{ $userRating->avatar_url ? asset('storage/' . $userRating->avatar_url) : 'https://static.thenounproject.com/png/6224470-200.png'}}" alt="ImageUser">
                    <h3 class="NomUser">{{ $userRating->name ?? '' }}</h3>      
                    <div class="rating">
                ...
                <hr class="divisionRating">
    
                @endforeach             
            </div> 
             <!-- Button Container -->  
             <div class="button-container" id="buttonContainer">
                <button id="close" class="button-theme buttonInformations">Close</button> <!-- Button 1 -->
                <button id="button-rating" class="button-theme buttonRatings">Back</button> <!-- Button 2 -->
...
<script>
    window.onclick = function (event) {
            if (event.target === document.getElementById("RatingPage")) {
                closeModal();
            }
    };
    ...
    function openModal() {
        document.getElementById("RatingPage").style.display = "flex";
    }
    ...
    document.getElementById('button-rating').addEventListener('click', function() {
        window.location.href = `${window.location.origin}/bon-plans/${getBonPlanIdFromUrl()}/menus/user/${getUserIdFromUrl()}`;
    });
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById("business-type-circle").style.backgroundColor = categorieProperties.color;

    // categorie icon theme
    document.getElementById("business-type-icon").classList.add(categorieProperties.icon);

    // buttons
    document.getElementById("close").style.backgroundColor = categorieProperties.color;
    document.getElementById("button-rating").style.backgroundColor = categorieProperties.color;
