    ...
    public function index($bon_plan_id): View
{
    ...
    $bon_plans = bonplan::where('id', $bon_plan_id)->get();

    return view('app.bon_plans.menu', compact('menus', 'offres','bon_plans'));
}
    /**
    ...
    public function show2($bon_plan_id): View
    {
        $menus = Menu::where('bon_plan_id', $bon_plan_id)
        ->latest()
        ->paginate(5)
    ...
    return view('app.bon_plans.menu', compact('menus', 'offres','bon_plans','user'));
}
